...
<div v-if="store.showCartTure" class="grid grid-cols-3 relative min-h-screen">
    <div class="col-span-1 sm:col-span-1 md:col-span-2 bg-black/80 h-full w-full"></div>
    <div v-if="store.slideItem.length > 0" class="col-span-2 sm:col-span-2 md:col-span-1 bg-white w-full h-full pt-5 pb-10">
    ...
    <div v-else class="col-span-2 sm:col-span-2 md:col-span-1 bg-white w-full h-full pt-20 pb-10">
